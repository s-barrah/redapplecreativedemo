...
Route::prefix('track')->group(function () {
    ...
    Route::post('/add', 'TrackController@add_track')->name('track.add');
    Route::post('/details', 'TrackController@get_track')->name('track.details');
    Route::post('/update', 'TrackController@update_track')->name('track.update');
...
Route::prefix('playlist')->group(function () {
    ...
    Route::post('/add', 'PlaylistController@add_playlist')->name('playlist.add');
    Route::post('/details', 'PlaylistController@get_playlist')->name('playlist.details');
    Route::post('/update', 'PlaylistController@update_playlist')->name('playlist.update');
